...
export default function ChatPage() {
  ...
  const renderMessage = (message) => {
    ...
    return (
      <div
        className="textss"
        style={{ padding: "0px", borderRadius: "5px", wordWrap: "break-word" }}
      >
        {text}
      </div>
    );
  ...
  return (
    <div style={{ padding: "20px" }} className="mm">
      <div className="s">
        ...
        <Link href={"https://www.npmjs.com/package/@google/generative-ai"}>
          <h2>Docs</h2>
        </Link>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ marginTop: "20px" }} className="frm">
        <div className="messageBox">
          ...
          <button id="sendButton" type="submit">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 664 663">
              ...
              <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="33.67" stroke="#6c6c6c"
